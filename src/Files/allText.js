...
const nameC = 'Campus Resources'
const blurbC = `Rice University itself provides career resources to students; many of these are applicable to CS students.
...
//Events Page
const nameE = 'Social Events'
const blurbE = `Throughout the year, we hold social events such as lunches, study breaks, mixers, bowling nights, 
and outings. We regularly host a study break or Christmas party after classes end. In past study breaks, we have had 
activities such as cookie decorating contest, gift exchange, video games, trivia, prizes and swag giveaways. We also 
host a movie night once a semester.`

const nameH = 'Hackathons'
const blurbH = `Rice CS Club hosts a yearly student-led hackathon, HackRice. During HackRice, students meet to code 
over the span of a day or two to build amazing projects! It’s simple: code, eat, sleep for the weekend and see what 
you come up with. At the end, participants demonstrate their apps to the audience and judges for a chance to win  prizes.`

export {nameS, blurbS, nameT, blurbT, nameE, blurbE, nameH, blurbH}