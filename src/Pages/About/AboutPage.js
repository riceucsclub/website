  ...
  return (
    <div className="relative">
      ...
      <div class="flex flex-col md:flex-row justify-center">
        <a className="flex justify-center py-1 m-2" href='https://docs.google.com/document/d/15nBECgAnR3ZiHaNqSZV-4NDMksp5aBd6aceaykslgeI/edit?usp=sharing' target="_blank">
