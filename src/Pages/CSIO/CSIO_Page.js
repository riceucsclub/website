...
function CSIO_Page() {
    ...
    let thirdtext = "If you have suggestions, please reach out to one of our committee members via their email address listed on this page, or fill out the Google form using the link below.";
    let link_gf = "https://forms.gle/b4mk1Zp4PqkGe2Tx8"


    return (
        <div className="bg-matterhorn">
            <Top_Part />

            <div className="relative z-10 bg-matterhorn">

                <div className="relative z-10 text-4xl bg-white font-bold">
                    <div className="text-4xl text-black ml-24 py-4 bg-white font-bold">Our Mission</div>
                </div>

                <div className="relative z-20 bg-matterhorn">
                    <div className="flex justify-center text-center bg-matterhorn mx-24 mt-24 text-white">{maintext}</div>
                    <div className="flex justify-center text-center mx-24 mt-8 bg-matterhorn text-white">{secondtext}</div>
                    <div className="flex justify-center text-center mx-24 mt-8 bg-matterhorn text-white">{thirdtext}</div>
                    <a className="flex justify-center text-center text-light-blue-gray mx-24 mt-2 bg-matterhorn text-white hover:text-white transition" href='https://forms.gle/b4mk1Zp4PqkGe2Tx8' target="_blank">
                        {link_gf}
                    </a>
                ...
                <div className="relative z-10 text-4xl mt-24 bg-white font-bold">
                    <div className="text-4xl text-black py-4 ml-24 bg-white font-bold">Meet the team</div>
                </div>
